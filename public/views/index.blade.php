...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:19 GMT -->
...
<!--<div id="right-sidebar" class="right-sidebar-notifcations nav-collapse">
    <div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
        ...
        <div id="w3lDemoBar" class="w3l-demo-bar">
            ...
            &lt;!&ndash;-<div class="responsive-icons">
    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke">
                ...
                <!--        <img src="assets/images/zimmer-logo.png" alt="Your logo" title="Your logo" style="height:35px;" />-->
                <!--    </a>-->
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ url('/blog') }}">Engine oil</a>
                                <a class="dropdown-item" href="{{ url('/blog-single') }}">Transmission oil</a>
                                <a class="dropdown-item" href="{{ url('/error') }}">Promotional accessories</a>
                        ...
                        <li class="nav-item">
                            <div class="nav-link language-container">
                                <a href="{{ url('/conctact') }}">RU</a>
                                <a href="{{ url('/contact') }}">EN</a>
                            </div>
                        </li>
    ...
    <section class="banner-19">
        <div class="banner-layer">
            <video autoplay muted loop id="myVideo">
                <source src="assets/videos/shellrefinery.mp4" type="video/mp4">
            ...
            <div class="main-content-top">
                <div class="container">
                    <div class="main-content">
                        ...
                        <h4>Zimmer Oil</h4>
                        <p class="mt-3">HIGH QUALITY, MODERN INNOVATIVE GERMAN TECHNOLOGY AT A FAVORABLE PRICE!</p>
        ...
        <div class="container py-md-5 py-sm-4">
            <div class="row">
                <div class="col-lg-6 left-wthree-img mb-lg-0 mb-4">
                    <img alt=" " class="img-fluid img-responsive" src="assets/images/zimmer-intro.png">
                </div>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4 mb-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative border-0">
                            <a href="services.html">
                                <img alt="card-image"
                                     class="d-block img-responsive" src="assets/images/products/5W-40%20FS%20ELITE%20LONG%20LIFE.png">
                            </a>
                        </div>
                        <div class="card-body service-details">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 content-image order-lg-first order-last">
                    <a href="#image"><img alt="content-photo" class="img-responsive"
                                          src="assets/images/zimmer-about.png"></a>
                </div>
    ...
    <section class="w3l-content-mid py-5">
        <div class="container py-md-5 py-4">
            <div class="welcome-left">
                ...
                <a class="btn btn-style mt-4" href="contact.html">Contact Us</a>
            </div>
        </div>
    </section>
    <!-- //content section -->
        ...
        <div class="container py-md-5 py-4">
            <div class="row sub-columns">
                ...
                <div class="col-lg-3 col-sm-6 sub-two-right pl-lg-5 mt-sm-0 mt-5">
                    <h6>Our Products</h6>
                    <ul>
                        <li><a href="services.html"><span class="fas fa-angle-right mr-2"></span>Engine Oil</a>
                        </li>
                        <li><a href="services.html"><span class="fas fa-angle-right mr-2"></span>Transmission Oil</a>
                        </li>
                        <li><a href="services.html"><span class="fas fa-angle-right mr-2"></span>Accessories</a>
                        </li>
                        <li><a href="services.html"><span class="fas fa-angle-right mr-2"></span>All Products</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <ul>
                        ...
                        <li><a href="blog.html"><span class="fas fa-angle-right mr-2"></span>Products</a>
                        </li>
            ...
            <div class="sub-contact mt-5 pt-lg-4">
                <div class="row">
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#ea83848c85aa8f928b879a868fc4898587"><span
                                    class="__cf_email__" data-cfemail="3e575058517e5b465f534e525b105d5153">info@zimmer-oil.com</span></a>
                            <p>Drop Us a Line</p>
                        </div>
                    </div>
                    <div class="col-md-4 footer-contact d-flex align-items-center active">
                        ...
                        <div>
                            <a href="tel:+44-000-888-999">+994 (12) 310-09-35</a>
                            <p>Call Us Now</p>
                        </div>
                    </div>
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <h5> Xətai rayonu, 8 Noyabr prospekti 23, indeks AZ 1025 </h5>
                            <p>Get Direction</p>
                        </div>
                    </div>
                </div>
