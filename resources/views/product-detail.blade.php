...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:25 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Execution - Corporate Category Bootstrap Responsive Website Template - Blog Single : W3Layouts</title>
    <!-- google-fonts -->
...
<div class="right-sidebar-notifcations nav-collapse" id="right-sidebar">
    <div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">

        <div class="w3l-demo-bar" id="w3lDemoBar">
            <div class="demo-btns">
            ...
            <span class="w3l-icon -download">
                ...
                <a class="no-margin-bottom-mobile" href="https://w3layouts.com/checkout/?add-to-cart=4763800000046471">
        ...
        <div class="right-sidebar-panel-content animated fadeInRight" style="overflow: hidden; outline: none;"
             tabindex="5003">
        </div>
    </div>
</div>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg stroke">
            ...
            <a class="navbar-brand" href="#index.html">
                <img alt="Your logo" src="assets/images/logo-rectangle-withoutbg.png" style="height:48px;"
                     title="Your logo"/>
            </a>
            <button aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation"
                    class="navbar-toggler  collapsed bg-gradient" data-target="#navbarTogglerDemo02" data-toggle="collapse"
                    type="button">
...
<section class="inner-banner">
    <div class="w3l-breadcrumb py-5">
        <div class="container py-xl-5 py-md-4 mt-5">
            <h4 class="inner-text-title font-weight-bold mb-sm-2">Blog Single</h4>
            <ul class="breadcrumbs-custom-path">
                <li><a href="index.html">Home</a></li>
                <li class="active"><span aria-hidden="true" class="fa fa-chevron-right mx-2"></span>Blog Single</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="container py-md-5 py-4">
            <div class="blog-posthny-info mx-auto" style="max-width:800px">
                <div class="style-title position-relative">
                    <h3 class="title-style mb-sm-3 mb-2">Ways to make visitors fall in love with your premium
                        website</h3>
                </div>
                <div class="single-post-image mb-4">
                    <ul class="blog-author-date mt-3 d-flex align-items-center mb-4">
                        <li class="circle avatar"><img alt="" class="img-fluid" src="assets/images/team2.jpg"></li>
                ...
                <div class="single-post-content">
                    ...
                    <blockquote class="blockquote quote my-5">
                        <q>
                            ...
                            totam
                            animi consequatur saepe blanditiis.</q>
                ...
                <div class="content-text-9 pb-sm-4">
                    <div class="single-post-content-1 row mt-5 no-gutters">
                        <div class="col-md-4">
                            <img alt="blog-post-image" class="img-fluid img-responsive mt-3"
                                 src="assets/images/blog1.jpg">
                        </div>
                        <div class="col-md-8 align-self">
                            <p class="mt-md-0 mt-4 ml-md-4 ml-0">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Animi
                                necessitatibus error dolore dolorem, aut possimus libero saepe doloremque sequi
                                consequatur non
                                veritatis quidem enim minima
                                totam, ratione
                                sunt? Quis esse laborum magnam dolorem excepturi fuga consequatur a cumque incidunt
                                aspernatur. </p>
                            <p class="mt-4 ml-md-4 ml-0">Quis esse laborum magnam dolorem excepturi fuga consequatur
                                a cumque incidunt
                                aspernatur. </p>
                        </div>
                    </div>
                    <div class="single-post-content-1 row mt-4 no-gutters">
                        <div class="col-md-8 align-self order-md-first order-last">
                            <p class="mr-md-4 mr-0">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Animi
                                necessitatibus error dolore dolorem, aut possimus libero saepe doloremque sequi
                                consequatur non
                                veritatis quidem enim minima
                                ...
                                sunt? Quis esse laborum magnam dolorem excepturi fuga consequatur a cumque incidunt
                                aspernatur. </p>
                            <p class="mt-4 mr-md-4 mr-0">Quis esse laborum magnam dolorem excepturi fuga consequatur
                                a cumque incidunt
                                aspernatur. </p>
                        </div>
                        <div class="col-md-4 order-md-last order-first mb-md-0 mb-4">
                            <img alt="blog-post-image" class="img-fluid img-responsive mt-3"
                                 src="assets/images/blog5.jpg">
                        </div>
                    </div>
                </div>
                <nav class="post-navigation row mt-5 py-5">
                    <div class="post-prev col-6 pr-sm-5">
                            <span class="nav-title">
                                <span class="fa fa-angle-double-left"></span> Prev Post </span>
                        <a class="posts-view posts-view-left" href="#url" rel="prev">
                            <img class="img-fluid postimg d-none img-responsive d-md-block"
                    ...
                    <div class="post-next col-6 pl-sm-5 text-right">
                        ...
                        <a class="posts-view posts-view-right" href="#url" rel="next">
                            <label>Lorem ipsum dolor sit amet</label>
                            <img class="img-fluid postimg d-none img-responsive d-md-block"
                ...
                <div class="comments mt-5">
                    ...
                    <div class="media mt-4">
                        <div class="img-circle">
                            <img alt="..." class="img-fluid" src="assets/images/testi1.jpg">
                        </div>
                        <div class="media-body">

                            <ul class="time-rply mb-2">
                                <li><a class="name mt-0 mb-1 d-block" href="#URL">Michael Smith</a>
                                    Mar 25, 2021 - 3:02 am

                                </li>
                                <li class="reply-last">
                                    <a class="reply" href="#reply"><span aria-hidden="true"
                                                                         class="fa fa-reply"></span> Reply</a>
                                </li>
                            </ul>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat, hic reprehenderit
                            eum cupiditate deleniti asperiores illum ad tenetur aliquam culpa fugit odit
                            consequatur.
                        </div>
                    </div>
                    ...
                    <div class="media">
                        <div class="img-circle">
                            <img alt="..." class="img-fluid" src="assets/images/testi2.jpg">
                        </div>
                        <div class="media-body">
                            <ul class="time-rply mb-2">
                                <li><a class="name mt-0 mb-1 d-block" href="#URL">Jeffrey Nadrich</a>
                                    Mar 26, 2021 - 3:02 am
                            ...
                            suscipit totam animi consequatur saepe blanditiis.Tempore saepe maxime illo laborum
                            obcaecati.
                            <div class="media second mt-5 p-0 pt-5">
                                <a class="img-circle img-circle-sm" href="#">
                                    <img alt="..." class="img-fluid" src="assets/images/testi3.jpg">
                                </a>
                                <div class="media-body">
                                    <ul class="time-rply mb-2">
                                        <li><a class="name mt-0 mb-1 d-block" href="#URL">Michael Nadrich</a>
                                            Mar 27, 2021 - 4:02 am
                                        </li>
                                        <li class="reply-last">
                                            <a class="reply" href="#reply"><span aria-hidden="true"
                ...
                <div class="leave-comment-form mt-lg-5 mt-4" id="comment">
                    <h4 class="side-title mb-4">Leave A Comment </h4>
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                                <textarea class="form-control" name="Comment" placeholder="Write Comment" required=""
    ...
    <div class="container py-md-5 py-4">
        <div class="row sub-columns">
            <div class="col-lg-4 col-sm-6 sub-one-left">
                ...
                <div class="columns-2">
                    <ul class="social">
                        <li><a href="#facebook" title="facebook"><span aria-hidden="true"
                                                                       class="fab fa-facebook-f"></span></a>
                        </li>
                        <li><a href="#linkedin" title="linkedin"><span aria-hidden="true"
                                                                       class="fab fa-linkedin-in"></span></a>
                        </li>
                        <li><a href="#twitter" title="twitter"><span aria-hidden="true"
                                                                     class="fab fa-twitter"></span></a>
                        </li>
                        <li><a href="#google" title="google"><span aria-hidden="true"
                                                                   class="fab fa-google-plus-g"></span></a>
                        </li>
                        <li><a href="#instagram" title="instagram"><span aria-hidden="true"
            ...
            <div class="col-lg-2 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                ...
                <ul>
                    ...
                    <li><a href="product.html"><span class="fas fa-angle-right mr-2"></span>Blog Posts</a>
                    </li>
        ...
        <div class="sub-contact mt-5 pt-lg-4">
            <div class="row">
                <div class="col-md-4 footer-contact d-flex align-items-center">
                    <span aria-hidden="true" class="fas fa-envelope-open"></span>
                    <div>
                        <a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#1c75727a735c79647d716c7079327f7371"><span
                                class="__cf_email__" data-cfemail="86efe8e0e9c6e3fee7ebf6eae3a8e5e9eb">[email&#160;protected]</span></a>
                        <p>Drop Us a Line</p>
                    </div>
                </div>
...
<script>(function () {
    var js = "window['__CF$cv$params']={r:'83a0f4d14cdc8ec8',t:'MTcwMzMzODE5Ni45MjYwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/74bd6362/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:26 GMT -->
</html>