        ...
        <div class="p-3 px-4 border-bottom">
            <div class="d-flex align-items-start ">
                <div class="flex-shrink-0 me-3 align-self-center">
                    <img src="{{ URL::asset('admins/assets/images/users/avatar-1.jpg') }}" class="avatar-sm rounded-circle" alt="">
                </div>
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img online align-self-center me-3">
                                                <img src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-sm" alt="">
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="{{ URL::asset('admins/assets/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                    ...
                    <div class="col-xl-4 col-7">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar-sm me-3 d-sm-block d-none">
                                <img src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" alt="" class="img-fluid d-block rounded-circle">
                            </div>
                            <div class="flex-grow-1">
