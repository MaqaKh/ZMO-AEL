...
@section('css')
<link href="{{ URL::asset('admins/assets/libs/datatables.net-bs4/datatables.net-bs4.min.css') }}" rel="stylesheet">
<link href="{{ URL::asset('admins/assets/libs/datatables.net-responsive-bs4/datatables.net-responsive-bs4.min.css') }}" rel="stylesheet" type="text/css" />
                     ...
                     <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                         ...
                         <tbody>
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-9.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
...
@endsection
@section('script')
<script src="{{ URL::asset('admins/assets/libs/datatables.net/datatables.net.min.js') }}"></script>
<script src="{{ URL::asset('admins/assets/libs/datatables.net-bs4/datatables.net-bs4.min.js') }}"></script>
<script src="{{ URL::asset('admins/assets/libs/datatables.net-responsive/datatables.net-responsive.min.js') }}"></script> --}}
<script src="{{ URL::asset('admins/assets/js/app.min.js') }}"></script>
<script src="{{ URL::asset('admins/assets/js/pages/datatable-pages.init.js') }}"></script>
@endsection
