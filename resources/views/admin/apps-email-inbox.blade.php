        ...
        <div class="email-leftbar card">
            ...
            <div class="mt-2">
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image" height="36">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="{{ URL::asset('admins/assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="{{ URL::asset('admins/assets/images/users/avatar-6.jpg') }}" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
...
<script src="{{ URL::asset('admins/assets/libs/@ckeditor/@ckeditor.min.js') }}"></script>
<script src="{{ URL::asset('admins/assets/js/pages/email-editor.init.js') }}"></script>
