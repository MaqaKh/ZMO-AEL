                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-lg-12 col-sm-6">
                                <img src="{{ URL::asset('admins/assets/images/undraw-calendar.svg') }}" alt="" class="img-fluid d-block">
                            </div>
                        </div>
...
@endsection
@section('script')
<script src="{{ URL::asset('admins/assets/libs/@fullcalendar/@fullcalendar.min.js') }}"></script>
<script src="{{ URL::asset('admins/assets/js/pages/calendar.init.js') }}"></script>
