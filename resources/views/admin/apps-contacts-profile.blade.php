                ...
                <div class="d-flex align-items-end mt-3 mt-sm-0">
                    <div class="flex-shrink-0">
                        <div class="avatar-xxl me-3">
                            <img src="@if (Auth::user()->avatar != ''){{ URL::asset('admins/images/'. Auth::user()->avatar) }}@else{{ URL::asset('admins/assets/images/users/avatar-1.png') }}@endif" alt="profile-image" class="img-fluid rounded-circle d-block img-thumbnail">
                        </div>
                    </div>
                            ...
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-lg me-3">
                                        <img src="{{ URL::asset('admins/assets/images/users/avatar-6.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('admins/assets/images/profile-bg.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                                ...
                                                <div class="avatar-group">
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                        </a>
                                                    </div>
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="{{ URL::asset('admins/assets/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="ms-2" >
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <div class="mt-4 pt-2">
                                            <div class="comment-section border-bottom pb-4">
                                                <div class="d-flex">
                                                    <img src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-md" alt="img-missing">
                                            ...
                                            <div class="comment-section pt-4">
                                                <div class="d-flex">
                                                    <img src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-md" alt="img-missing">
                                                    <div class="flex-1 ms-4">
                                                        <div class="post-meta float-end">
                                                            <span><i class="mdi mdi-calendar me-2"></i>Feb 13, 2021</span>
                                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-lg me-3">
                                        <img src="{{ URL::asset('admins/assets/images/users/avatar-9.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('admins/assets/images/profile-bg-2.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                        <div >
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-group">
                                                    ...
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="{{ URL::asset('admins/assets/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                        </a>
                                                    </div>
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="{{ URL::asset('admins/assets/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="ms-2" >
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap">
                        <tbody>
                            <tr>
                                <td style="width: 50px;"><img src="{{ URL::asset('admins/assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-sm" alt=""></td>
                            ...
                            <tr>
                                <td><img src="{{ URL::asset('admins/assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-sm" alt=""></td>
                            ...
                            <tr>
                                <td><img src="{{ URL::asset('admins/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-sm" alt=""></td>
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-start mt-2">
                            <img src="@if (Auth::user()->avatar != ''){{ URL::asset('images/'. Auth::user()->avatar) }}@else{{ URL::asset('admins/assets/images/users/avatar-1.png') }}@endif" alt="" class="rounded-circle avatar-lg">
                        </div>
...
<script src="{{ URL::asset('admins/assets/js/pages/profile.init.js') }}"></script>
<script>
