                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <div class="conversation-list">
                                <div class="d-flex">
                                    <img src="admins/assets/images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="">
                                    <div class="flex-1">
                        ...
                        <li class="right">
                            <div class="conversation-list">
                                <div class="d-flex">
                                    ...
                                    <img src="admins/assets/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="">
                                </div>
                                                ...
                                                <ul class="list-inline message-img mt-3  mb-0">
                                                    <li class="list-inline-item message-img-list">
                                                        <a class="d-inline-block m-1" href="">
                                                            <img src="admins/assets/images/small/img-1.jpg" alt="" class="rounded img-thumbnail">
                                                        </a>
                                                    </li>

                                                    <li class="list-inline-item message-img-list">
                                                        <a class="d-inline-block m-1" href="">
                                                            <img src="admins/assets/images/small/img-2.jpg" alt="" class="rounded img-thumbnail">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
