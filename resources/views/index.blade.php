        ...
        <div class="container py-md-5 py-sm-4">
            <div class="row">
                <div class="col-lg-6 left-wthree-img mb-lg-0 mb-4">
                    <img alt=" " class="img-fluid img-responsive" src={{asset('images/zimmer-intro.png')}}>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 content-image order-lg-first order-last">
                    <a href="#image"><img alt="content-photo" class="img-responsive"
                                          src={{asset('images/zimmer-about.png')}}></a>
                </div>
        ...
        <div class="container py-md-5 py-4">
            <div class="row sub-columns">
                ...
                <div class="col-lg-3 col-sm-6 sub-two-right pl-lg-5 mt-sm-0 mt-5">
                    <h6>Our Products</h6>
                    <ul>
                        <li><a href="{{ url('/services') }}"><span class="fas fa-angle-right mr-2"></span>Engine Oil</a>
                        </li>
                        <li><a  href="{{ url('/services') }}"><span class="fas fa-angle-right mr-2"></span>Transmission Oil</a>
                        </li>
                        <li><a  href="{{ url('/services') }}"><span class="fas fa-angle-right mr-2"></span>Accessories</a>
                        </li>
                        <li><a  href="{{ url('/services') }}"><span class="fas fa-angle-right mr-2"></span>All Products</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-6 sub-two-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <ul>
                        ...
                        <li><a  href="{{ url('/blog') }}"><span class="fas fa-angle-right mr-2"></span>Products</a>
                        </li>
