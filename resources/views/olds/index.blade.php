        ...
        <div class="container py-md-5 py-sm-4">
            <div class="row">
                <div class="col-lg-6 left-wthree-img mb-lg-0 mb-4">
                    <img alt=" " class="img-fluid img-responsive" src="assets/images/zimmer-intro.jfif">
                </div>
...
<!--                                    <a href="product-detail.html" class="blog-desc">Why a visual identity system is more-->
<!--                                        memorable-->
<!--                                    </a>-->
...
<!--                                        <a href="product.html" class="blog-icon-e"><i class="fas fa-plus"></i></a>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                            <div class="col-sm-6">-->
<!--                                <div class="card-body blog-details align-self pl-sm-0">-->
<!--                                    <a href="product-detail.html" class="blog-desc">Make website that surpasses amongst all-->
<!--                                        the</a>-->
<!--                                    <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit.</p>-->
<!--                                    <div class="d-flex align-items-center justify-content-between mt-lg-4 mt-5">-->
