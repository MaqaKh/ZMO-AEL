...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/shortcodes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Execution - Corporate Category Bootstrap Responsive Website Template - Shortcodes : W3Layouts</title>
    <!-- google-fonts -->
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="product.html">Blog Posts</a>
                                <a class="dropdown-item" href="product-detail.html">Blog Single</a>
                                ...
                                <a class="dropdown-item active" href="shortcodes.html">Shortcodes</a>
                            </div>
                        </li>
                        <li class="nav-item">
    ...
    <section class="inner-banner">
        <div class="w3l-breadcrumb py-5">
            <div class="container py-xl-5 py-md-4 mt-5">
                <h4 class="inner-text-title font-weight-bold mb-sm-2">Shortcodes</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>Shortcodes</li>
                </ul>
            </div>
        </div>
    </section>
...
<!---728x90--->
        ...
        <div class="container py-md-5 py-4">
            <div class="row align-items-center mb-5">
                <div class="col-md-6 section-heading">
                    <h5 class="small-title-2">Shortcodes</h5>
                    <h3 class="title-style-2">Bootstrap Components</h3>
                </div>
            ...
            <div class="typo-wthree">
                <!-- blockquotes -->
                <h4 class="pt-4 pb-3">Jumbotron</h4>
    ...
    <span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-primary btn-lg mt-4"</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">role=</span><span class="s">"button"</span><span class="nt">&gt;</span>Learn more<span class="nt">&lt;/a&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre>
                </figure>
                <h4 class="pt-4 pb-3">Fluid jumbotron</h4>
                <div class="bd-example">
...
<span class="nt">&lt;/div&gt;</span></code></pre>
                ...
                <!-- breadcrumb -->
                <h5 class="pt-md-4 pb-2">Breadcrumb</h5>
...
<span class="p">&lt;/</span><span class="nt">div</span><span class="p">&gt;</span></code></pre>
                ...
                <!-- display -->
                <h4 class="pt-4 pb-3">Display headings</h4>
                <div class="bd-example">
...
<span class="nt">&lt;h1</span> <span class="na">class=</span><span class="s">"display-4"</span><span class="nt">&gt;</span>Display 4<span class="nt">&lt;/h1&gt;</span></code></pre>
                ...
                <!-- //display -->
                <!-- blockquotes -->
                <h4 class="pt-4 pb-3">Blockquotes with Naming a source</h4>
                <div class="bd-example">
...
<span class="nt">&lt;/blockquote&gt;</span></code></pre>
                ...
                <h4 class="pt-4 pb-3">alighnments</h4>
                <div class="bd-example">
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-link"</span><span class="nt">&gt;</span>Link<span class="nt">&lt;/button&gt;</span></code></pre>
                ...
                <h5 class="pt-4">Outline buttons</h5>
                <div class="bd-example">
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-outline-dark"</span><span class="nt">&gt;</span>Dark<span class="nt">&lt;/button&gt;</span></code></pre>
                ...
                <!-- flex -->
                <h4 class="pt-4 pb-3">Flex Properties</h4>
                ...
                <!-- Flex Direction -->
                <h4 class="pt-4 pb-3">Flex Direction</h4>
                <div class="row">
                    <div class="col-lg-6">
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"d-flex justify-content-around"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre>
                ...
                <div class="bd-example">
                    <h1 class="texti">Example heading <span class="badge badge-secondary">New</span></h1>
                    <h2 class="texti">Example heading <span class="badge badge-secondary">New</span></h2>
                    <h3 class="texti">Example heading <span class="badge badge-secondary">New</span></h3>
                    <h4 class="texti">Example heading <span class="badge badge-secondary">New</span></h4>
                    <h5 class="texti style-2">Example heading <span class="badge badge-secondary">New</span></h5>
                    <h6 class="texti">Example heading <span class="badge badge-secondary">New</span></h6>
                </div>
                <figure class="highlight">
                    <pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1&gt;</span>Example heading <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"badge badge-secondary"</span><span class="nt">&gt;</span>New<span class="nt">&lt;/span&gt;&lt;/h1&gt;</span>
...
<span class="nt">&lt;h6&gt;</span>Example heading <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"badge badge-secondary"</span><span class="nt">&gt;</span>New<span class="nt">&lt;/span&gt;&lt;/h6&gt;</span></code></pre>
                </figure>
                <!-- //badges -->
                <!-- lists -->
...
<span class="nt">&lt;/table&gt;</span></code></pre>
                ...
                <h5 class="pt-4 pb-3">Live demo</h5>
                <div class="bd-example">
    ...
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"modal-dialog"</span> <span class="na">role=</span><span class="s">"document"</span><span class="nt">&gt;</span>
        <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"modal-content"</span><span class="nt">&gt;</span>
            ...
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"modal-body"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;p&gt;</span>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                   doloremque laudantium, totam rem aperiam.
...
<span class="nt">&lt;/div&gt;</span></code></pre>
                ...
                <h5 class="pt-4 pb-3">Vertically centered</h5>
                <div class="bd-example">
                    <!-- Button trigger modal -->
...
<span class="nt">&lt;/form&gt;</span></code></pre>
                ...
                <h5 class="pt-4 pb-3">Readonly plain text</h5>
                <div class="bd-example">
                    <form>
    ...
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group row"</span><span class="nt">&gt;</span>
        ...
        <span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">readonly</span> <span class="na">class=</span><span class="s">"form-control-plaintext"</span> <span class="na">id=</span><span class="s">"staticEmail"</span> <span class="na">value=</span><span class="s">"<a href="https://p.w3layouts.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="71141c10181d311409101c011d145f121e1c">[email&#160;protected]</a>"</span><span class="nt">&gt;</span>
        <span class="nt">&lt;/div&gt;</span>
    <span class="nt">&lt;/div&gt;</span>
    <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group row"</span><span class="nt">&gt;</span>
            ...
            <div class="sub-contact mt-5 pt-lg-4">
                <div class="row">
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#80e9eee6efc0e5f8e1edf0ece5aee3efed"><span class="__cf_email__" data-cfemail="b9d0d7dfd6f9dcc1d8d4c9d5dc97dad6d4">[email&#160;protected]</span></a>
                            <p>Drop Us a Line</p>
                        </div>
                    </div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'83a0f4d81d858ec8',t:'MTcwMzMzODE5OC4wMTcwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/74bd6362/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>


<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/07-04-2021/execution-liberty-demo_Free/985771955/web/shortcodes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Dec 2023 13:30:27 GMT -->
</html>